...
public class Resep extends javax.swing.JFrame {
    DefaultListModel<String> listResep = new DefaultListModel<>();
    /**
    ...
    public void tambahDaftar(String nama, String keluhan, String penyakit, ArrayList resepObat){
        jLabel6.setText(nama);
        jLabel7.setText(keluhan);
        jLabel8.setText(penyakit);
        int i = 0;
        while(i < resepObat.size()){
            listResep.addElement((String) resepObat.get(i));
            i = i + 1;
        }
        jList1.setModel(listResep);
    }
    /**
